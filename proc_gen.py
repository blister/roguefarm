...
def place_entities(
	...
	monsters: List[Entity] = get_entities_at_random(
		enemy_chances, num_monsters, floor_number
	)
...
def tunnel_between(
	...
	"""Return a random L-shaped tunnel between these two points"""
	x1, y1 = start
	x2, y2 = end 
...
def generate_dungeon(
	...
	for r in range(max_rooms):
		...
		#add this new room to our room list
